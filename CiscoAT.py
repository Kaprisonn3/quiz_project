...
def generate_cards(csv_file="input_questions_and_answers_cisco.csv") -> list[Memocard]:
    ...
    with open(csv_file, newline='') as questions_and_answers:
        ...
        for row in memocard_generator:
            ...
            id += 1
    # Add a last question to indicate that the game is over
    memocards.append(Memocard(-1,"LAST QUESTION TEXT", "", picture="quiz_done.jpg", is_last=True)) #TODO: ./quiz_done??? eller sådan her
    return memocards 
